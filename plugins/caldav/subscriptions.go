...
func (s Subscription) info(account string) dav.Collection {
	return dav.Collection{Path: s.path(), Name: s.Name, Color: s.Color, Address: s.URL,
		Components: []string{"VEVENT"}, Account: account}
}
