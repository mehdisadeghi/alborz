...
func handleUnifiedMailbox(ctx *alborz.Context) error {
	...
	sortKey, sortDir, reverse, err := readSort(ctx)
	if err != nil {
		return err
	}
...
// as written, and which way that runs.
func readSort(ctx *alborz.Context) (sortKey, sortDir string, reverse bool, err error) {
